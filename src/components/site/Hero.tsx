...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden radial-spotlight">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 sm:py-20 md:grid-cols-2 md:py-28">
        <div>
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[10px] uppercase tracking-[0.2em] text-muted-foreground sm:text-xs">
            <span className="h-1.5 w-1.5 rounded-full bg-white" />
            Detailing • Protection • Performance
          </div>
          <h1 className="font-display text-4xl font-bold uppercase leading-[0.95] tracking-tight sm:text-5xl md:text-7xl">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4 text-xs uppercase tracking-widest text-muted-foreground sm:gap-6">
        ...
        <div className="relative order-first md:order-none">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black p-2 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.8)]">
            <img src={logo} alt="M&H Auto Care logo" className="aspect-square h-full w-full rounded-xl object-cover" />
          </div>
        </div>
      </div>
